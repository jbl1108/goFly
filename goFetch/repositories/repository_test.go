...
import (
	...
	"github.com/jbl1108/goFly/goFetch/restservice"
...
func TestgoFly/goFetchRequest(t *testing.T) {
	var restClient = NewRestClient()
	var m = make(map[string]string)
	result, err := restClient.Request("http://localhost:8000/goFly/goFetch", m)

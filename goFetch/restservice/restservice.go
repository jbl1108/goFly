...
func Start() {
	r := mux.NewRouter()
	r.HandleFunc("/goFly/goFetch", goFly/goFetch)
...
func goFly/goFetch(w http.ResponseWriter, r *http.Request) {
	io.WriteString(w, getgoFly/goFetchJson())
}
...
func getgoFly/goFetchJson() (b string) {
